...
from langgraph.prebuilt import create_react_agent, create_supervisor, InjectedState
...
"""
    ...
    return create_react_agent(
        model_selector.get_worker_model("chat_interface"),
...
def create_first_supervisor() -> Any:
    ...
    members = ["first_worker", "other_supervisor"]
...
"""
    ...
    return create_supervisor(
        model_selector.get_supervisor_model(),
        members,
        system_prompt,
...
"""
    ...
    return create_react_agent(
        model_selector.get_worker_model("researcher"),
...
"""
    ...
    return create_react_agent(
        model_selector.get_worker_model("writer"),
        tools=[request_more_research, complete_task],
        state_schema=HierarchicalAgentState,
        messages_modifier=SystemMessage(content=system_prompt)
    )
...
class ProductionHierarchicalSystem:
    ...
    def create_main_graph(self):
        ...
        builder.add_node("other_supervisor", other_level)
        ...
        builder.add_edge("other_supervisor", "first_supervisor")
...
def create_langgraph_json():
    ...
    config = {
        "node_mapping": {
            "main_graph": "main_agent_entry"
        },
        "graphs": {
            "main_agent_entry": {
                "title": "Hierarchical Multi-Agent System",
                "description": "Production hierarchical multi-agent system with strict routing controls",
...
production_system = ProductionHierarchicalSystem(use_persistence=True)
